  ...
  transition: function(data) {
    if (Train.templates[Game.current_car][data.x][data.y] === "Wall_grate") {
      if(data.x == Game.LEFT_X) {
        console.log('TRANSITION: Current car: ' + Game.current_car);
        console.log('transition left, data.x: ' + data.x)
        console.log('last scene: ' + Game.last_scene);
        console.log('current scene: ' + Game.current_car);
        Game.last_scene = Game.current_car;
        var next_scene = Train.which_car("left");
        console.log('next scene: ' + next_scene);
        ...
        console.log('TRANSITION: Current car: ' + Game.current_car);
        console.log('transition right, data.x: ' + data.x); 
        console.log('last scene: ' + Game.last_scene);
        console.log('current scene: ' + Game.current_car);
        Game.last_scene = Game.current_car;
