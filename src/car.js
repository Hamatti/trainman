...
function get_car(car_type) {
	...
	if (car_type=="bar") {
		...
		var car = [empty_block, wall_left, car_part1, car_part2,
	...
	if (car_type=='passenger') {
		...
		var passenger_car = [empty_block, wall_left, p_part1, p_part2,
	...
	if (car_type == 'engine') {
		...
		var engine = [empty_block, wall_left, e_part1, e_part2, e_part1,
